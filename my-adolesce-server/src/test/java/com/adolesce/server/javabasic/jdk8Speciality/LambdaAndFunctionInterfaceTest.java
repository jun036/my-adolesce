...
public class LambdaAndFunctionInterfaceTest {
    ...
    //自定义函数式接口，1.8新注解,主要用于编译级错误检查，加上该注解，当你写的接口不符合函数式接口定义的时候，编译器会报错。
    @FunctionalInterface
    ...
    public void testMethodReference() {
        //无参构造器引用
        Copier<LambdaAndFunctionInterfaceTest> interfaceTest1 = LambdaAndFunctionInterfaceTest::new;
        ...
        LambdaAndFunctionInterfaceTest interfaceTest2 = interfaceTest1.copy();
        LambdaAndFunctionInterfaceTest interfaceTest3 = new LambdaAndFunctionInterfaceTest();
        ...
        //特定类的任意对象的方法引用
        Consumer<String> printHello = interfaceTest3::printHello;
        printHello.accept("reboot");

        //特定实例对象的方法引用
        MathOperation thisAdd = interfaceTest2::thisAdd;
