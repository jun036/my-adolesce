 ...
 */
@Component
public class MyApplicationContextInitializer2 implements ApplicationContextInitializer, Ordered {
    @Autowired
    private RedisTemplate<String, String> redisTemplate;//nohave

    @Override
    public void initialize(ConfigurableApplicationContext applicationContext) {
        System.err.println("1、通过ApplicationContextInitializer2初始化执行....");
    }
